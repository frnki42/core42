...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/07 18:19:51 by efembock          #+#    #+#             */
/*   Updated: 2025/01/07 18:19:54 by efembock         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include "so_long.h"
...
{
	if (check_wall(game, keycode) && game->map.array[game->player.y][game->player.x] == '0')
	{
	...
	else if (check_wall(game, keycode) && game->map.array[game->player.y][game->player.x] == 'E')
	{
		mlx_put_image_to_window(game->mlx, game->win,
			game->tex_exit, game->player.x * 32, game->player.y * 32);
		game->player.x -= 1;
		mlx_put_image_to_window(game->mlx, game->win,
			game->player.xpm_left, game->player.x * 32, game->player.y * 32);
		game->player.moves++;
